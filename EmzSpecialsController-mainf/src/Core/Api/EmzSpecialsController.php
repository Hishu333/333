...
namespace EmzSpecialsCollection\Core\Api;
 ...
 */
class EmzSpecialsController extends AbstractController
{
    ...
    /**
     * @Route("/api/v{version}/_action/emz-specials-collection/generate", name="api.custom.emz_specials_collection.generate", methods={"POST"})
     * @return Response
     */
